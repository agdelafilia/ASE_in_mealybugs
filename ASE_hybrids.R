...
s1.hybrid <- read_delim("/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/hybrid/5_ase/results/ASE_output/S1.csv", 
                      "\t", escape_double = FALSE, trim_ws = TRUE)
s3.hybrid <- read_delim("/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/hybrid/5_ase/results/ASE_output/S3.csv", 
                      "\t", escape_double = FALSE, trim_ws = TRUE)
s6.hybrid <- read_delim("/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/hybrid/5_ase/results/ASE_output/S6.csv", 
                      "\t", escape_double = FALSE, trim_ws = TRUE)
t1.hybrid <- read_delim("/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/hybrid/5_ase/results/ASE_output/T1.csv", 
                      "\t", escape_double = FALSE, trim_ws = TRUE)
t3.hybrid <- read_delim("/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/hybrid/5_ase/results/ASE_output/T3.csv", 
                      "\t", escape_double = FALSE, trim_ws = TRUE)
t6.hybrid <- read_delim("/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/hybrid/5_ase/results/ASE_output/T6.csv", 
                      "\t", escape_double = FALSE, trim_ws = TRUE)
...
contigs_with_anno <- read_csv("/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/hybrid/5_ase/results/ASE_output/contigs_with_anno.bed", 
                              col_names = FALSE) # list of contigs where annotation features lie
...
s1.hybrid_ASE_anno_R <- read_delim("/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/hybrid/5_ase/results/ASE_output/S1_anno_for_R.bed", 
                                 "\t", escape_double = FALSE, col_names = FALSE, 
                                 trim_ws = TRUE)
s3.hybrid_ASE_anno_R <- read_delim("/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/hybrid/5_ase/results/ASE_output/S3_anno_for_R.bed", 
                                 "\t", escape_double = FALSE, col_names = FALSE, 
                                 trim_ws = TRUE)
s6.hybrid_ASE_anno_R <- read_delim("/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/hybrid/5_ase/results/ASE_output/S6_anno_for_R.bed", 
                                 "\t", escape_double = FALSE, col_names = FALSE, 
                                 trim_ws = TRUE)
t1.hybrid_ASE_anno_R <- read_delim("/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/hybrid/5_ase/results/ASE_output/T1_anno_for_R.bed", 
                                 "\t", escape_double = FALSE, col_names = FALSE, 
                                 trim_ws = TRUE)
t3.hybrid_ASE_anno_R <- read_delim("/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/hybrid/5_ase/results/ASE_output/T3_anno_for_R.bed", 
                                 "\t", escape_double = FALSE, col_names = FALSE, 
                                 trim_ws = TRUE)
t6.hybrid_ASE_anno_R <- read_delim("/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/hybrid/5_ase/results/ASE_output/T6_anno_for_R.bed", 
                                 "\t", escape_double = FALSE, col_names = FALSE, 
                                 trim_ws = TRUE)
...
# start with exonic sites, so that exonic SNPs that map to other features (e.g. introns) will be given prioritu
...
pc_asa_hybrid <- read_delim("/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/hybrid/5_ase/results/ASE_output/PC_pure_ASE_sites_check.csv",
...
snp.plot.hybrid.testis = ggplot(final_filter_hybrid_testis, aes(bias_mean)) +
  ...
  labs(title="CF reproductive tract", y="SNPs", x = expression(paste(p[m]))) +
...
#grid.arrange(bias.plot.hybrid.soma,bias.plot.hybrid.testis,nrow=1)
...
#write.csv(genes_final_filter_hybrid_soma, file = "/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/results/genes_final_filter_hybrid_soma.csv")
#write.csv(genes_final_filter_hybrid_testis, file = "/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/results/genes_final_filter_hybrid_testis.csv")
...
#write.csv(genes_biparental_pat_soma_hybrids, file = "/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/results/genes_biparental_pat_soma_hybrids.csv")
#write.csv(genes_biparental_pat_testis_hybrids, file = "/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/results/genes_biparental_pat_testis_hybrids.csv")
#write.csv(genes_nonmat_soma_hybrids, file = "/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/results/genes_nonmat_soma_hybrids.csv")
#write.csv(genes_nonmat_testis_hybrids, file = "/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/results/genes_nonmat_testis_hybrids.csv")
...
genes.hybrid.testis.counts.plot <- ggplot(genes_final_filter_hybrid_testis_counts, aes(bias.cat, perc)) + ylim(c(0,90)) +
  ...
  scale_x_discrete(limit = c("maternal.only", "maternal.bias", "biparental","paternal.bias","paternal.only"),
                   labels = c("M","MB","B","PB","P")) +
  geom_text(aes(label=N),position = position_dodge(0.9),vjust=-1) +
  labs(title="CF reproductive tract", y="%", x = "Category of bias") +
  theme(plot.title = element_text(hjust = 0.5, family = "Helvetica", size = (14)), 
        axis.title = element_text(family = "Helvetica", size = (13)),
        axis.text = element_text(family = "Helvetica", size = (12)),
        legend.text = element_text(family = "Helvetica", size = (12)),
...
#grid.arrange(genes.hybrid.soma.counts.plot,genes.hybrid.testis.counts.plot,nrow=2)


log.labels <- expression("10"^0, "10"^1, "10"^2, "10"^3, "10"^4, "10"^5, "10"^6, "10"^7)
...
genes.testis.scatterplot = ggplot(genes_final_filter_hybrid_testis, aes(x=(1+ref.all), y=(1+alt.all),group=bias.cat)) + geom_point(aes(colour=bias.cat,shape=bias.cat),size=1.8) +
  ...
  scale_colour_manual(name="Bias",values=c("#2980B9","#85C1E9","#AED6F1","#3498DB","#2471A3"),
                      breaks=c("maternal.only","maternal.bias","biparental","paternal.bias","paternal.only"),
                      labels=c("M", "MB", "B","PB","P")) +
  labs(title="CF reproductive tract", y="Paternal SNP counts", x = "Maternal SNP counts") +
  geom_abline(slope = 1,linetype="dotted", color = "gray50") +
  theme(plot.title = element_text(hjust = 0.5, family = "Helvetica", size = (14)), 
        axis.title = element_text(family = "Helvetica", size = (13)),
        axis.text = element_text(family = "Helvetica", size = (12)),
...
s.gene.tpm.barplot = ggplot(s.gene.tpm.stats, aes(bias.cat, mean, fill = bias.cat)) +
  ...
  scale_x_discrete("Expression bias to maternal genome",limits=c("paternal.only","paternal.bias","biparental","maternal.bias","maternal.only"),
                   labels=c(" P ", " PB ", " B "," MB "," M ")) +
  labs(y="Average TPM") +
  #ggtitle("Gene expression levels and\n degree of bias in soma") +
...
fig.1d = ggplot(tissue_correlation_hybrid, aes(x=s.bias, y=t.bias)) + geom_point(size=0.5,aes(colour=agree)) + 
  labs(title="",x = expression(paste(p[m]," in soma",paste())), y = expression(paste(p[m]," in reproductive tract",paste()))) +
...
fig.1e <- ggplot(tissue_correlation_hybrid_count, aes(s.cat, t.cat)) + geom_point(aes(size = 5*N),alpha=0.2,
  ...
  labs(title="",x = "Soma", y = "Reproductive tract") +
  theme(legend.position = "none") +
  theme(panel.background = element_rect(fill = 'white', colour = 'black')) +
  theme(panel.grid.minor = element_line(colour = "black",size=0.01),panel.grid.major = element_line(colour = "black",size=0.01))


#tiff("/Users/agarcia/Documents/genomics/RNA_seq_projects/mealybugs/manuscript/fig1.revision.tiff",
 #    width = 3900, height = 3400, units = 'px', res = 300)
#grid.arrange(grid.rect(gp=gpar(col="white")),snp.plot.hybrid.soma,snp.plot.hybrid.testis,
#             genes.hybrid.soma.counts.plot,genes.soma.scatterplot,fig.1d,
#             genes.hybrid.testis.counts.plot,genes.testis.scatterplot,fig.1e,ncol=3)
#dev.off()